...
public class AKPickerView: UIView, AKPickerViewDataSource,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
    ...
    public func getValue1(item:Int) -> Int{
        return (startPoint + (item/divider))
    }
    public func getValue2(item:Int)-> Int{
        return ((item % divider))
    }
    ...
    public lazy var font = UIFont.systemFontOfSize(12)
    
    /// Readwrite. A font which used in selected cells.
    public lazy var highlightedFont = UIFont.boldSystemFontOfSize(12)
