...
class ExplanationScreens: UIView {
    ...
    override func awakeFromNib() {
        ...
        let legalSubTitle = " Consult with your doctor before changing your diet. By using these meal plans you accept all responsibility for any impact it has upon your health."
